...
Stampa a schermo l'avanzamento di ogni misura e salva tutti i numeri in `benchmark_results.json`. Richiede 1-2 minuti; è basato su un ciclo di misurazione scritto ad hoc (media, min, max, numero di iterazioni per ciascuna operazione, riportati esplicitamente).
